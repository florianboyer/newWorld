...
<body>
    ...
    <form method="GET" id="controleInscription" name="controleInscription" action="inscription.php">
        <div class="tab-pane inscription">
            <h2>Mon comptes</h2><br>
            <!-- <on récupere le pseudo de la personne connecté -->
           <?php
            $pseudo = $_SESSION["pseudo"];
            $nom = $_SESSION["nom"];
            $prenom = $_SESSION["prenom"];
            $dateDeNaissance = $_SESSION["dateDeNaissance"];
            $numeroRue = $_SESSION["numeroRue"];
           ...
           <details>
            ...
            <div class="md-form form-sm">
                ...
                <input type="text" id="form25" name="pseudo" class="form-control" placeholder="Votre pseudo" value="<?php echo $pseudo ?>" readonly>
                <label for="form25"></label>
            </div>
            <div class="md-form form-sm">
                <i class="fa fa-user prefix"></i>
                <input type="text" id="form24" name="nom" class="form-control" placeholder="Votre Nom" value="<?php echo $nom ?>" readonly>
                <label for="form24"></label>
            </div>
            <div class="md-form form-sm">
                <i class="fa fa-user prefix"></i>
                <input type="text" id="form24" name="prenom" class="form-control" placeholder="Votre Prénom" value="<?php echo $prenom ?>" readonly>
                <label for="form24"> </label>
            </div>
            <div class="md-form form-sm">
                <i class="fa fa-user prefix"></i>
                <input type="date" id="form24" name="dateDeNaissance" class="form-control" placeholder="Votre date de naissance" value="<?php echo $dateDeNaissance ?>">
                <label for="form24"> </label>
            </div>
            <div class="md-form form-sm">
                <i class="fa fa-firefox prefix"></i>
                <input type="mail" id="form24" name="mail" class="form-control" placeholder="Votre mail" value="<?php echo $mail ?>">
                <label for="form24"> </label>
            </div>
            <div class="md-form form-sm">
                <i class="fa fa-firefox prefix"></i>
                <input type="mail" id="form24" name="mdp" class="form-control" placeholder="mdp" value="<?php echo $mdp ?>">
                <label for="form24"> </label>
            </div>                    
            <div class="md-form form-sm">
                <i class="fa fa-map-marker prefix"></i>
                <input type="text"  name="adresse" id="idAdresse"   value="<?php echo $adresse ?>">  
                <label for="form24"> </label>
            </div>
                       </details>
            <div class="md-form form-sm">
                <i class="fa fa-building-o prefix"></i>
                <input type="text" name="numeroRue" id="idNumero" readonly  value="<?php echo $numeroRue ?>">
                <label for="form24"> </label>
            </div>
            <div class="md-form form-sm">
                <i class="fa fa-building-o prefix"></i>
